...
<main class="tj-help-section py-5">
    <div class="container py-3">
        ...
        <ul class="nav nav-tabs tj-help-filters" id="helpTab" role="tablist">
            ...
            <li class="nav-item" role="presentation">
                <button class="nav-link" id="shopping-tab" data-bs-toggle="tab" data-bs-target="#shopping-pane" type="button" role="tab" aria-controls="shopping-pane" aria-selected="false">Shopping</button>
            </li>
            <li class="nav-item" role="presentation">
            ...
            <li class="nav-item" role="presentation">
                <button class="nav-link" id="shipping-tab" data-bs-toggle="tab" data-bs-target="#shipping-pane" type="button" role="tab" aria-controls="shipping-pane" aria-selected="false">Shipping</button>
            </li>
            <li class="nav-item" role="presentation">
                <button class="nav-link" id="returns-tab" data-bs-toggle="tab" data-bs-target="#returns-pane" type="button" role="tab" aria-controls="returns-pane" aria-selected="false">Returns</button>
            </li>
            <li class="nav-item" role="presentation">
                <button class="nav-link" id="account-tab" data-bs-toggle="tab" data-bs-target="#account-pane" type="button" role="tab" aria-controls="account-pane" aria-selected="false">Account</button>
            </li>
            <li class="nav-item" role="presentation">
                ...
                <div class="tj-faq-container">
                    <div class="tj-faq-item active">
                        ...
                        <div class="tj-faq-answer">
                            Once your parcel leaves our Fort Smith studio, you’ll receive an email with a tracking number. You can also open Account → My Orders, select the order and choose Track Package for live carrier updates.
                        </div>
                    </div>
                    ...
                    <div class="tj-faq-item">
                        ...
                        <div class="tj-faq-answer">
                            We accept all major credit cards (Visa, MasterCard, American Express, Discover) as well as secure online payment gateways.
                        </div>
                    </div>
                    ...
                    <div class="tj-faq-item">
                        ...
                        <div class="tj-faq-answer">
                            Standard shipping typically takes 3 to 5 business days, while express shipping takes 1 to 2 business days depending on your location.
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="tab-pane fade" id="shopping-pane" role="tabpanel" aria-labelledby="shopping-tab" tabindex="0">
                <div class="tj-faq-container">
                    <div class="tj-faq-item">
                        ...
                        <div class="tj-faq-answer">
                            You can check our detailed size guide available on every product page to find the perfect fit based on your measurements.
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="tab-pane fade" id="orders-pane" role="tabpanel" aria-labelledby="orders-tab" tabindex="0">
                <div class="tj-faq-container">
                    <div class="tj-faq-item">
                        ...
                        <div class="tj-faq-answer">
                            Orders can be modified or cancelled within 1 hour of placement before they enter the fulfillment process at our studio.
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="tab-pane fade" id="shipping-pane" role="tabpanel" aria-labelledby="shipping-tab" tabindex="0">
                <div class="tj-faq-container">
                    <div class="tj-faq-item">
                        ...
                        <div class="tj-faq-answer">
                            Standard shipping typically takes 3 to 5 business days, while express shipping takes 1 to 2 business days.
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="tab-pane fade" id="returns-pane" role="tabpanel" aria-labelledby="returns-tab" tabindex="0">
                <div class="tj-faq-container">
                    <div class="tj-faq-item">
                        ...
                        <div class="tj-faq-answer">
                            Yes, we offer easy returns within 30 days of purchase for unworn and unwashed items in their original condition.
                        </div>
                    </div>
                </div>
            </div>
