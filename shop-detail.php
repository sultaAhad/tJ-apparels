...
<style>
   ...
   .tj-product-subtitle {
    ...
    .tj-color-btn.active, .tj-color-btn:hover {
        border-color: var(--tj-pink);
    ...
    .tj-size-btn.active, .tj-size-btn:hover {
                    ...
                    <div class="swiper swiper-main">
                        <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide">
                                <div class="img-zoom-container" id="imgZoomContainer">
                                    <img src="<?php echo $img; ?>" alt="<?php echo htmlspecialchars($product['title']); ?>" id="activeZoomImg">
                                </div>
                            </div>
                            <?php endforeach; ?>
                        </div>
                ...
                <div class="tj-product-content">
                    ...
                    <div class="mb-4">
                        ...
                        <div class="tj-size-selector mt-2">
                            ...
                            <button type="button" class="tj-size-btn <?php echo $index === 0 ? 'active' : ''; ?>" onclick="selectSize(this)"><?php echo $size; ?></button>
                            <?php endforeach; ?>
                        </div>
                    </div>
                    ...
                    <div class="tj-purchase-box">
                        ...
                        <a href="checkout" type="button" class="tj-wishlist-action" title="Add to Wishlist">
    ...
    document.addEventListener("DOMContentLoaded", function () {
        ...
        zoomContainers.forEach(container => {
            ...
            container.addEventListener("mousemove", function (e) {
                ...
                img.style.transform = "scale(2)"; // Zoom scale factor (2x)
            });
